...
export default function Operadores() {
  ...
  const [formData, setFormData, limparRascunhoOperador] = useAutoSaveForm('rascunho-novo-operador', {
    nome: '',
    sobrenome: '',
    funcao: '',
    email: '',
    ...
    <div className="space-y-6 pb-20 animate-in fade-in duration-500">
      ...
      {isModalOpen && (
        <div className="fixed inset-0 bg-zinc-900/40 backdrop-blur-sm z-50 flex items-end sm:items-center justify-center p-0 sm:p-4">
          <div className="bg-white w-full max-w-lg rounded-t-[2.5rem] sm:rounded-[2.5rem] shadow-2xl overflow-hidden animate-in zoom-in-95 duration-300 max-h-[92vh] overflow-y-auto">
